...
def select_codehilite_theme(theme_name):
    try:
        ...
        current_themes = {
            ...
            "pastie": code_hilite_theme_pastie,
            "vim": code_hilite_theme_vim,
            "fruity": code_hilite_theme_fruity,
        }
        return current_themes[theme_name]
    except:
        return current_themes["monokai"]
